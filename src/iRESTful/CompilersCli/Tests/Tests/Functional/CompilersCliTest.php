...
final class CompilersCliTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testCompile_CRUD_Success() {
        ...
        $command = 'php /vagrant/bin/irestful-api-compiler http://127.0.0.1:8080 '.$this->crud.' '.$this->output;
    ...
    public function testCompile_Custom_Success() {
        ...
        $command = 'php /vagrant/bin/irestful-api-compiler http://127.0.0.1:8080 '.$this->custom.' '.$this->output;
        shell_exec($command);
